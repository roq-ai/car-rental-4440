  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Rental - Empowering you to manage, book, and track vehicles with ease. Your profile, reservations, and vehicle performance, all in one central place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Rental - Empowering you to manage, book, and track vehicles with ease. Your profile, reservations, and vehicle performance, all in one central place.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Read" type="read" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
